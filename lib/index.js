 ...
 * 
 * @param {object} config - Configuration object (will be serialized to JSON)
...
async function extract(config, options = {}) {
  ...
  const resultJson = nativeAddon.extract(configJson, options);
...
async function watch(config, options = {}) {
  ...
  nativeAddon.watch(configJson, options);
}
